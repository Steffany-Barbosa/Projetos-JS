...
function getQuote() {
  ...
  quoteAutor.textContent = " - " + quotes[index].author; // Acessando as propriedades, das citações

  console.log(index);
}
//Math.random() - esta sendo usado para retornar uma citação aleatória.

//Criando disparo do botão
